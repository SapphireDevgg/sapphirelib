...
local aa = {
    function()
        ...
        function x.SafeCallback(y, z, ...)
            ...
            if not A then
                local C, D = B:find ":%d+: "
                if not D then
                    return x:Notify {Title = "SapphireLib", Content = "Callback error", SubContent = B, Duration = 5}
                end
                return x:Notify {
                    Title = "SapphireLib",
    ...
    [53] = function()
        ...
        return {
            ...
            AcrylicBorder = Color3.fromRGB(130, 40, 40),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(180, 30, 30), Color3.fromRGB(100, 20, 20)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(140, 40, 40),
            Tab = Color3.fromRGB(180, 60, 60),
            Element = Color3.fromRGB(200, 50, 50),
            ElementBorder = Color3.fromRGB(110, 30, 30),
            InElementBorder = Color3.fromRGB(120, 40, 40),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(200, 50, 50),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(200, 50, 50),
            DropdownFrame = Color3.fromRGB(200, 80, 80),
            DropdownHolder = Color3.fromRGB(120, 30, 30),
            ...
            InputFocused = Color3.fromRGB(30, 0, 0),
            InputIndicator = Color3.fromRGB(170, 60, 60),
            Dialog = Color3.fromRGB(120, 30, 30),
            DialogHolder = Color3.fromRGB(95, 20, 20),
            DialogHolderLine = Color3.fromRGB(90, 15, 15),
            DialogButton = Color3.fromRGB(120, 30, 30),
            DialogButtonBorder = Color3.fromRGB(155, 40, 40),
            DialogBorder = Color3.fromRGB(100, 30, 30),
            DialogInput = Color3.fromRGB(135, 35, 35),
            DialogInputLine = Color3.fromRGB(190, 60, 60),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
...
-- Toggle Button Script (Exemplo básico)
local toggle = true
...
button.MouseButton1Click:Connect(function()
    toggle = not toggle
    main_ui.Enabled = toggle -- Supondo que main_ui seja o ScreenGui
end)

-- Ícone na UI Principal
main_ui.Icon = "rbxassetid://84476370801298"
